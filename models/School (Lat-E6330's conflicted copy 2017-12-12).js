...
var SchoolSchema = new Schema({
	...
	average_school_fees: { type: String },
	curriculum: { type: String, required:false, enum:[1,2,3], unique:false},
	...
	gallery: { 
		gallery_item: { type: String },
		gallery_main: { type: Number }
	},
	other_programs: { type: [String], required:false,unique:false },
	combinations: {
